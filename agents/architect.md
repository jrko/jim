...
description: >
  ...
  wants to generate or update docs/jim/ARCHITECTURE.md. Do not use for spec creation
  ...
  user: "/jim:plan docs/jim/specs/005-architect/spec.md"
  ...
  user: "/jim:arch"
  assistant: "I'll scan the codebase and generate docs/jim/ARCHITECTURE.md."
  <commentary>
  ...
  user: "implement the plan from docs/jim/specs/005-architect/plan.md"
...
- Research: `docs/jim/specs/{group}/{00X}-{name}/research.md` (same directory as spec)
- Plans: `docs/jim/specs/{group}/{00X}-{name}/plan.md` (same directory as spec)
...
- **Strategic alignment.** docs/jim/ARCHITECTURE.md is a locked constraint. docs/jim/VISION.md is upstream context. Flag conflicts — do not silently encode them.
...
- `/jim:arch` — handles codebase scanning, docs/jim/VISION.md context, and architecture template population
