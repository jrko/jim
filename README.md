...
See [`WORKFLOW.md`](docs/jim/WORKFLOW.md) for the full SDLC process.

Jim builds itself using its own workflow. Jim's specs live in [`docs/jim/specs/`](docs/jim/specs/).
