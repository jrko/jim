---
spec: "docs/specs/jim/010-sec/spec.md"
status: Active
date: "2026-04-11"
---
...
- **`ARCHITECTURE.md`** (L191–197) — Existing security considerations section. The security agent should read this to avoid contradicting established trust boundaries.
