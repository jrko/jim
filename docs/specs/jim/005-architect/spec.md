...
- [ ] Plan written to `docs/specs/{group}/{id}-{name}/plan.md`
...
- [ ] Accepts `$ARGUMENTS` as: empty (creates/updates ARCHITECTURE.md at project root), or directory path (creates for a subdirectory)
