...
- **Chosen:** `docs/debug/{YYYYMMDD}-{topic}.md` as specified in the spec.
...
### Debug Report Frontmatter Contract (`docs/debug/{YYYYMMDD}-{topic}.md`)
...
| Debug report at `docs/debug/{YYYYMMDD}-{topic}.md` | 4 |
