...
*Last updated: 2026-04-11 (010-sec build)*
...
│       ├── specs/           # Numbered spec directories (001–010)
...
- **Location:** `agents/` — `pm.md` (L1–75), `architect.md` (L1–81), `researcher.md` (L1–84), `security.md` (L1–80), `coder.md` (L1–84), `meta.md` (L1–64)
...
- **Location:** `docs/jim/specs/{group}/{00X}-{name}/` — currently `docs/jim/specs/jim/001-meta/` through `010-sec/`
...
| :--- | :--- | :--- | :--- | :--- |
| Spec Archive | Markdown files | `docs/jim/specs/` | Persistent development artifacts — specs, research, plans, security reviews | PM, Architect, Researcher, Security |
