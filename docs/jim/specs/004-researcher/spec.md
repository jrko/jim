...
status: draft
origin:
  - docs/jim/prior-art/V1SDLC/v1-agent-researcher.md
  - docs/jim/prior-art/V1SDLC/v1-researcher-skill.md
---
...
- [ ] When invoked against a spec: written to the same directory (`docs/jim/specs/{group}/{id}-{name}/research.md`)
