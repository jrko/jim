...
**Output:** `docs/jim/VISION.md` (or plugin root for jim-developing-jim).
...
**Output:** `docs/jim/ROADMAP.md` (or plugin root for jim-developing-jim).
...
**Filename:** `docs/jim/brainstorms/{YYYYMMDD}-{topic}.md`
...
- [ ] The skill actively searches for existing specs via docs/jim/specs/ to auto-link deliverables where applicable.
...
- [ ] The skill produces files at `docs/jim/brainstorms/{YYYYMMDD}-{topic}.md`.
...
flowchart TD
    ...
    B["/jim:brainstorm"] --> BM["docs/jim/brainstorms/\n{date}-{topic}.md"]
