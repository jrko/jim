...
spec: "docs/jim/specs/007-arch-feedback/spec.md"
type: feature
status: complete
---
...
```mermaid
flowchart TD
    TASKS["All tasks marked [x]"] --> CHECK{"docs/jim/ARCHITECTURE.md\nexists?"}
