...
status: approved
origin:
  - docs/jim/prior-art/V1SDLC/v1-agent-coder.md
  - docs/jim/prior-art/V1SDLC/v1-coder-skill.md
---
...
- [ ] Produces a structured debug report at `docs/jim/debug/{YYYYMMDD}-{topic}.md`
