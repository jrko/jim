...
User describes idea (or invokes /jim:spec [name])
  │
  ├─ Read docs/jim/VISION.md + docs/jim/ARCHITECTURE.md (if they exist)
  │    └─ Missing? Note conversationally, proceed
  │
  ├─ Check docs/jim/specs/{group}/ for existing specs
