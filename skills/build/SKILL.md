...
2. Check if `BACKLOG.md` exists at the project root. If it does, invoke `/jim:backlog` to regenerate it — the PM will scan for deferred work, consolidate items, and present the updated backlog for your approval. If `BACKLOG.md` does not exist, skip this step.
